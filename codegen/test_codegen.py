...
from codegen.cpp_helpers import (
  to_cpp_type, to_cpp_literal, to_cpp_call, to_cpp_var_decl, escape_cpp_string, escape_cpp_char
)
...
def test_cpp_printer() -> None:
  ...
  expected = "int main() {\n  int x = 42;\n}"
  assert printer.get_code() == expected, f"Expected:\n{expected}\nGot:\n{printer.get_code()}"
...
def test_cpp_helpers_type() -> None:
  ...
  assert to_cpp_type(t4) == "std::array<int, 5>"
  
  # Complex nesting: const std.unique_ptr<int[3]>& -> unique_ptr of std::array<int, 3> ref
  t5 = TypeNode(
    name="std.unique_ptr",
    type_arguments=[TypeNode(name="int", array_size=3)],
    is_ref=True
  )
  assert to_cpp_type(t5) == "std::unique_ptr<std::array<int, 3>>&"
...
def test_cpp_helpers_literals() -> None:
  ...
  assert to_cpp_literal(StringLiteral(value="hello\n\"world\"")) == '"hello\\n\\"world\\""'
...
def test_cpp_helpers_structure() -> None:
  ...
  assert to_cpp_var_decl("float", "y", "3.14f", is_const=True) == "const float y = 3.14f;"
...
def test_cpp_visitor_expressions() -> None:
  ...
  z = Identifier(name="z")
  # x + y * z
  b1 = BinaryOperator(operator="+", left=x, right=BinaryOperator(operator="*", left=y, right=z))
  assert visitor.visit(b1) == "x + y * z"
  # (x + y) * z
  b2 = BinaryOperator(operator="*", left=BinaryOperator(operator="+", left=x, right=y), right=z)
  ...
  p_ptr.symbol = Symbol(name="p_ptr", kind="variable", type=TypeNode(name="std.unique_ptr", type_arguments=[TypeNode(name="int")]))
  ...
  # 5. Call Expression
  # foo(1, x) -> foo(1, x)
  c1 = CallExpression(function=Identifier(name="foo"), arguments=[IntegerLiteral(value="1"), x])
  ...
  c3 = CallExpression(
    function=CallExpression(function=Identifier(name="logger"), arguments=[], is_lambda_call=True),
  ...
  lam = LambdaExpression(
    params=[Parameter(name=Identifier(name="msg"), type=TypeNode(name="string_view"))],
  ...
  sw = SwitchExpression(
    value=x,
    cases=[Case(pattern=IntegerLiteral(value="1"), body=IntegerLiteral(value="10"))],
...
def test_cpp_visitor_statements() -> None:
  ...
  v1 = VariableDeclaration(name=Identifier(name="x"), type=TypeNode(name="int"), kind="var", value=IntegerLiteral(value="42"))
  assert visitor.visit(v1) == "int x = 42;"
  
  v2 = VariableDeclaration(name=Identifier(name="y"), type=None, kind="const", value=FloatLiteral(value="3.14f"))
  assert visitor.visit(v2) == "const auto y = 3.14f;"
  
  v3 = VariableDeclaration(name=Identifier(name="z"), type=TypeNode(name="Particle"), kind="ref", value=Identifier(name="p"))
  assert visitor.visit(v3) == "Particle& z = p;"

  # 2. Block & Return & Assignment
  stmt1 = VariableDeclaration(name=Identifier(name="x"), type=None, kind="var", value=IntegerLiteral(value="1"))
  stmt2 = AssignmentStatement(left=Identifier(name="x"), right=IntegerLiteral(value="2"))
  ...
  if_stmt = IfExpression(
    condition=BinaryOperator(operator=">", left=Identifier(name="x"), right=IntegerLiteral(value="0")),
  ...
  if_init_stmt = IfExpression(
    condition=VariableDeclaration(name=Identifier(name="res"), type=None, kind="const", value=Identifier(name="calc")),
  ...
  for_in_const = ForInStatement(
    ...
    body=Block(statements=[ExpressionStatement(expression=CallExpression(function=Identifier(name="print"), arguments=[Identifier(name="item")]))])
  )
  ...
  for_in_mut = ForInStatement(
    variable=Identifier(name="item"),
    iterable=Identifier(name="items"),
    body=Block(statements=[AssignmentStatement(left=Identifier(name="item"), right=IntegerLiteral(value="10"))])
  )
  ...
  # 6. ForCStatement
  for_c = ForCStatement(
    init=VariableDeclaration(name=Identifier(name="i"), type=TypeNode(name="int"), kind="var", value=IntegerLiteral(value="0")),
    condition=BinaryOperator(operator="<", left=Identifier(name="i"), right=IntegerLiteral(value="10")),
    increment=UnaryOperator(operator="++", operand=Identifier(name="i"), is_prefix=False),
  ...
  assert visitor.visit(ForInfiniteStatement(body=Block(statements=[BreakStatement()]))) == "for (;;) {\n  break;\n}"
  assert visitor.visit(WhileStatement(condition=BooleanLiteral(value="True"), body=Block(statements=[ContinueStatement()]))) == "while (true) {\n  continue;\n}"
  assert visitor.visit(AssertStatement(condition=Identifier(name="cond"), message=StringLiteral(value="fail"))) == 'assert((cond) && "fail");'
...
def test_cpp_visitor_declarations() -> None:
  ...
  p2 = Parameter(name=Identifier(name="y"), type=TypeNode(name="float"), default=FloatLiteral(value="1.0f"))
  assert visitor.visit_parameter(p2) == "float y = 1.0f"

  # 2. EnumDeclaration
  enum_decl = EnumDeclaration(
    name=Identifier(name="Color"),
    variants=[Identifier(name="Red"), Identifier(name="Green"), Identifier(name="Blue")]
  )
  ...
  ctor = ConstructorDeclaration(
    ...
    body=Block(statements=[
      AssignmentStatement(left=MemberAccess(object=Identifier(name="this"), member=Identifier(name="x")), right=Identifier(name="px")),
      AssignmentStatement(left=MemberAccess(object=Identifier(name="this"), member=Identifier(name="y")), right=Identifier(name="py"))
    ])
  )
  ...
  method = MethodDeclaration(
    ...
    return_type=TypeNode(name="void"),
    body=Block(statements=[
      AssignmentStatement(left=MemberAccess(object=Identifier(name="this"), member=Identifier(name="x")), right=BinaryOperator(operator="+", left=MemberAccess(object=Identifier(name="this"), member=Identifier(name="x")), right=Identifier(name="dx")))
    ])
  )
...
def test_unity_builder() -> None:
  ...
  prog = Program(statements=[
    ...
    EnumDeclaration(name=Identifier(name="SpaceType"), variants=[Identifier(name="Dim2D")]),
    FunctionDeclaration(
      name=Identifier(name="main"),
      params=[],
      return_type=TypeNode(name="int"),
      body=Block(statements=[ReturnStatement(value=IntegerLiteral(value="0"))])
    )
  ])
  ...
  assert code.strip() == expected_code.strip(), f"Expected:\n{expected_code}\nGot:\n{code}"
  ...
  prog2 = Program(statements=[
    ...
    ModuleDeclaration(name=Identifier(name="physics")),
    StructDeclaration(name=Identifier(name="Vector2"), fields=[Field(name=Identifier(name="x"), type=TypeNode(name="float"))]),
    FunctionDeclaration(
      name=Identifier(name="main"),
      params=[],
      return_type=TypeNode(name="int"),
  ...
  assert merged_code.strip() == expected_merged.strip(), f"Expected:\n{expected_merged}\nGot:\n{merged_code}"
...
def test_codegen_fixes_and_enhancements() -> None:
  ...
  if_ternary = IfExpression(
    condition=BinaryOperator(operator=">", left=x_id, right=IntegerLiteral(value="0")),
    then_body=Block(statements=[ExpressionStatement(expression=IntegerLiteral(value="1"))]),
    else_body=Block(statements=[ExpressionStatement(expression=IntegerLiteral(value="0"))])
  )
  ...
  sw = SwitchExpression(
    ...
    cases=[
      Case(
        ...
        body=Block(statements=[ExpressionStatement(expression=IntegerLiteral(value="10"))])
      )
    ],
    else_body=Block(statements=[ExpressionStatement(expression=IntegerLiteral(value="0"))])
  )
  ...
  space_type.symbol.declaration = EnumDeclaration(name=Identifier(name="SpaceType"), variants=[])
  ...
  for_c = ForCStatement(
    init=AssignmentStatement(left=Identifier(name="i"), right=IntegerLiteral(value="0")),
    condition=BinaryOperator(operator="<", left=Identifier(name="i"), right=IntegerLiteral(value="10")),
    increment=UnaryOperator(operator="++", operand=Identifier(name="i"), is_prefix=False),
    body=Block(statements=[PassStatement()])
  )
  ...
  prog = Program(statements=[
    FunctionDeclaration(
      ...
      body=Block(statements=[
        ...
        ExpressionStatement(expression=LambdaExpression(
          params=[],
          return_type=TypeNode(name="void"),
          body=Block(statements=[])
        ))
